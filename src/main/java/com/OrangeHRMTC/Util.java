...
public class Util extends Baseclass {
	...
	public static void validation(String Expectedresult, String ActualResult) throws Exception {
		if (Expectedresult.equals(ActualResult)) {
			System.out.println("Expected result:' " + Expectedresult + " 'matching to actual result:' " + ActualResult
					+ " 'Test passed");
		} else {
			throw new Exception("Expected result:' " + Expectedresult + " 'is not matching to actual result:' "
